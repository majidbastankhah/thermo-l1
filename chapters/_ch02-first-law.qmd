# First Law of Thermodynamics {#sec-ch2}
...
let you do with the integral in @eq-ch2-work?*
...
## Explore it yourself {#sec-ch2-explore}
...
## End-of-chapter problems {#sec-ch2-problems}
...
**P2.1 [easy].** Air contained within a piston–cylinder assembly is slowly
...
**P2.2 [easy].** As shown in the figure, 5 kg of steam contained within a
...
**P2.3 [easy].** A closed system of mass 5 kg undergoes a process in which there is
...
**P2.4 [easy].** A closed system of mass 20 kg undergoes a process in which there
...
**P2.5 [medium].** A stop is located 20 mm above the piston at the position shown.
...
**P2.6 [medium].** The refrigerant R-410a contained in the cylinder is at 1000 kPa,
...
**P2.7 [medium].** A 200 mm diameter piston compresses the air inside a cylinder by
...
**P2.8 [medium].** A gas contained within a
...
**P2.9 [medium].** The following table gives data, in
...
**P2.10 [medium].** Four kilograms of carbon monoxide (CO) is contained in a rigid
...
**P2.11 [hard].** Warm air is contained in a piston–cylinder assembly oriented
...
**P2.12 [hard].** Gaseous CO$_2$ is contained in a vertical piston–cylinder assembly
