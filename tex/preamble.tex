...
\definecolor{duAmber}{HTML}{C77700}
...
% student copy, end-of-chapter problems: a blank that fills the rest of the
% page, followed by a page break, so every problem gets a page of its own
\newcommand{\gapfill}{%
  \par\vspace{0.6em}%
  \noindent
  \begin{tcolorbox}[enhanced, height fill, colback=white, frame hidden,
      borderline={0.4pt}{0pt}{duPurple!25, dashed}, arc=2pt]
  \mbox{}
  \end{tcolorbox}%
  \clearpage
}
...
% the note at the start of the end-of-chapter problems: deliberately a colour
% nothing else in the notes uses
\newtcolorbox{ttryfirst}{
  enhanced, breakable, colback=duAmber!10, colframe=duAmber,
